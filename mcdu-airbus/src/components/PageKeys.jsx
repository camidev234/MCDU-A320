...
export const PageKeys = () => {
  ...
  const { changePage } = useContext(BaseContext);
  ...
  return (
    <div className="btns w-[93%] flex flex-col gap-2">
      <article className="firstRow 0 w-full flex items-center gap-3 justify-center">
        ...
        <button className="bg-black text-white text-[10px] h-6 w-9 rounded-sm shadow-button" onClick={redirectData}>DATA</button>
