    ...
    return (
      <div className="alphakeys w-full h-full bg-brown-500 flex flex-col gap-2">
        <article className="flex justify-evenly">
          ...
          <button className="w-6 h-6 bg-gray-950 rounded-md text-white flex justify-center items-center border border-white" onClick={() => handleChange("A")}><div className="bg-black rounded-full w-[80%] h-[80%] text-sm" onClick={() => handleChange("E")}>E</div></button>
        </article>
        <article className=" flex justify-evenly">
        ...
        <article className=" flex justify-evenly">
          ...
          <button className="w-6 h-6 bg-gray-950 rounded-md text-white flex justify-center items-center border border-white" onClick={() => handleChange("N")}><div className="bg-black rounded-full w-[80%] h-[80%] text-sm">N</div></button>
        ...
        <article className=" flex justify-evenly">
          ...
          <button className="w-6 h-6 bg-gray-950 rounded-md text-white flex justify-center items-center border border-white" onClick={() => handleChange("S")}><div className="bg-black rounded-full w-[80%] h-[80%] text-sm">S</div></button>
        ...
        <article className=" flex justify-evenly">
          ...
          <button className="w-6 h-6 bg-gray-950 rounded-md text-white flex justify-center items-center border border-white" onClick={() => handleChange("W")}><div className="bg-black rounded-full w-[80%] h-[80%] text-sm">W</div></button>
